...
var sources = {
    ...
    css: [
        ...
        {
            name: "bootstrap-touch-carousel.css",
            paths: [
    ...
    fonts: [
        {
            ...
            path: paths.bower + "bootstrap/dist/fonts/*.{ttf,svg,woff,woff2,otf,eot}"
        },
        {
            name: "font-awesome",
    ...
    lib: [
        ...
        },
        {
            ...
            paths: [
                paths.bower + "jquery-fittext.js/jquery.fittext.js"
            ]
        },
        {
            name: "wow.js",
            paths: [
                paths.bower + "wow.js/dist/wow.js"
            ]
        },
        {
            name: "classie.js",
...
gulp.task("watch-css", function () {
    return gulp
        .watch(paths.styles + "**/*.{css,scss,less}", ["build-css"])    // Watch the styles folder for file changes.
