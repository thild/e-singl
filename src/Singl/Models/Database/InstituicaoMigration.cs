    ...
    internal static class InstituicaoMigration
    {
        public static void Create(DatabaseContext context)
        {
            context.Instituicao.Add(new Instituicao
            {
                ...
                Historico = @"
                    <h3>UNIVERSIDADE ESTADUAL DO CENTRO-OESTE (UNICENTRO)</h3>
